...
(function() {
    ...
    var cmdGeo = {
        ...
        variables: function() {
            ...
            this.gpsAvailable = 'GPS_AVAILABLE';
            this.gpsUnavailable = 'GPS_UNAVAILABLE';
            this.positionUpdated = 'POSITION_UPDATED';
            this.refreshRate = 1000;
            this.currentPosition = currentPositionMarker = customDebugging = debugId = map = interval = intervalCounter = updateMap = false;
            this.locationRow = markerRij = [];
        },
        ...
        startInterval: function(event) {
            ...
            updatePosition();
            interval = self.setInterval(updatePosition, this.refreshRate);
        ...
        generateMap: function(myOptions, canvasId) {
            ...
            // Zorg dat de kaart geupdated wordt als het this.positionUpdated event afgevuurd wordt
            ET.addListener(this.positionUpdated, updatePositie);
        },
